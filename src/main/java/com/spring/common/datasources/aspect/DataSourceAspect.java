package com.spring.common.datasources.aspect;

import com.spring.common.datasources.DataSourceNames;
import com.spring.common.datasources.DynamicDataSource;
...
public class DataSourceAspect implements Ordered {
    ...
    @Pointcut("execution(* com.spring.*.dao.*.*(..)) " +
            "|| @annotation(com.spring.common.datasources.annotation.DataSource) " +
            "|| @within(com.spring.common.datasources.annotation.DataSource)")
